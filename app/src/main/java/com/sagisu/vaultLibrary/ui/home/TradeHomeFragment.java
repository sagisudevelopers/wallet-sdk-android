...
import com.sagisu.vaultLibrary.databinding.TradeHomeFragmentBinding;
import com.sagisu.vaultLibrary.models.Coins;
import com.sagisu.vaultLibrary.ui.BuyCoinsActivity;
import com.sagisu.vaultLibrary.ui.ReceiveCryptoActivity;
import com.sagisu.vaultLibrary.ui.login.fragments.User;
import com.sagisu.vaultLibrary.ui.trade.CryptoTokensListAdapter;
import com.sagisu.vaultLibrary.ui.trade.SelectCoinsFragment;
import com.sagisu.vaultLibrary.ui.trade.send.SendActivity;
import com.sagisu.vaultLibrary.ui.trade.watchlists.TokenWatchlistsActivity;
...
public class TradeHomeFragment extends Fragment implements CoinListAdapter.ICoinSelectionListener, CryptoTokensListAdapter.ICoinSelectionListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel.getUserData().observe(getViewLifecycleOwner(), new Observer<User>() {
            ...
            public void onChanged(User user) {
                if (user != null) {
                    /*mViewModel.setUserName(user.getFullName());
                    mViewModel.switchProfile(user);*/
                    if (user.getBusinessVaults().isEmpty()) mViewModel.setHasBusinessProfile(false);
                    if (mViewModel.getCurrentProfile().getValue().getProfile() == null)
                        mViewModel.setProfile(user.getFullName(), user.getVaultAccountId(), TradeHomeViewModel.ProfileEnum.PERSONAL);
                    else if (mViewModel.getSwitchProfile() != null) mViewModel.switchProfile();
    ...
    public void onResume() {
        ...
        mViewModel.checkForUserNameChange();
    }
